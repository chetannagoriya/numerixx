...
export default function Home() {
  return <main>
    ...
    <section className="hero" id="home">
      <div className="hero-copy"><p className="eyebrow"><Sparkles size={15}/> Welcome,</p><h1>I’m <em>Harpreet Kaur</em></h1><p className="hero-role">Researcher · Strategic Consultant · Human Behaviour Practitioner</p><div className="ornament"><span/>✦<span/></div><h2>Personalised guidance for every stage of life</h2><p className="lead">Whether you’re facing uncertainty, making an important decision, or seeking deeper self-understanding, my consultations help you recognise recurring patterns and move forward with clarity.</p><a className="button" href="#services">Explore Numerixx <ArrowUpRight size={16}/></a><img className="hero-stilllife" src="/assets/numerixx-stilllife.jpg" alt="Numerology books, candle and amethyst crystal"/></div>
      <div className="hero-portrait"><img src="/assets/harpreet-hero.jpg" alt="Harpreet Kaur seated in her consultation space"/><div className="portrait-badge"><Star size={16} fill="currentColor"/><span><strong>300+</strong> lives guided</span></div></div><div className="hero-wave"/>
    </section>
