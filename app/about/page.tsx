...
export default function About() {
  return <main><SiteHeader/>
    <section className="about-reference-hero">
      ...
      <div className="about-reference-photo"><img src="/assets/harpreet-portrait-provided.png" alt="Harpreet Kaur, founder of Numerixx"/><div className="about-stat stat-one"><b>6+</b><span>Years of Numerology Experience</span></div><div className="about-stat stat-two"><b>300+</b><span>Happy Clients Guided</span></div></div>
    </section>
